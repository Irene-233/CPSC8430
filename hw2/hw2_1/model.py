...
def test(testdata,outfile):
    ...
    ixtoword = pd.Series(np.load('./data/ixtoword.npy',allow_pickle=True).tolist())
    ...
    for idx, video_feat_path in enumerate(test_videos):
        ...
        generated_sentences.append({"caption": generated_sentence, "id": video_feat_path})
    print 'get bleu score ',bleu_score_avg[0],'\n'
